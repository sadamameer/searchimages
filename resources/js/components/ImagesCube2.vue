        ...
        <div v-if="images.length" class="mt-3">
            <div v-if="!FirstLoaded">
                ...
                <carousel-3d 
                    ...
                    :height="300"
                >
                    <slide :index="index" v-for="index in (images.length / 25)" :key="index">
                        <div class="row m-auto">
                            <div class="col p-0"><img :src="images[index].url_m"></div>
                            <div class="col p-0"><img :src="images[index].url_m"></div>
                            <div class="col p-0"><img :src="images[index].url_m"></div>
                            <div class="col p-0"><img :src="images[index].url_m"></div>
                            <div class="col p-0"><img :src="images[index].url_m"></div>
...
export default {
    ...
    watch: {
        images: function (val) {
            ...
            console.log(getChunkedData());

            // this.images = getChunkedData();
